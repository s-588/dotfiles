...
local function on_attach(client, bufnr)
	...
	if client:supports_method("textDocument/documentHighlight") then
		local under_cursor_highlights_group = vim.api.nvim_create_augroup("s-588/cursor_highlights", { clear = false })
	...
	if client:supports_method("textDocument/inlayHint") then
		local inlay_hints_group = vim.api.nvim_create_augroup("s-588/toggle_inlay_hints", { clear = false })
